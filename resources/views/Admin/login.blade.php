<!DOCTYPE html>
    ...
    <body class="gray-bg" style="background-image: url(/img/admin.jpg);">
        <div class="middle-box text-center loginscreen animated fadeInDown" style="top:20%;position: relative;">
            <div>
                {{--<div>--}}
                    {{--<h1 class="logo-name">SHOP+</h1>--}}
                {{--</div>--}}
                <h2>Welcome to BCSHOP+</h2>
                <p>
                    &nbsp;
                </p>
